...
import com.team766.framework.StatusBus.Entry;
...
public class MechanismTest extends TestCase {
    ...
    public void testFailedCheckContextReservationInProcedure() {
        ...
        var cmd2 = new FakeProcedure(1, Set.of(mech)).createCommandToRunProcedure();
        cmd2.schedule();
    ...
    public void testSuperstructure() {
        class TestSuperstructure extends Superstructure {
