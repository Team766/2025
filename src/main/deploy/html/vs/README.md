...
- This vs folder should be functional, however it is also quite bloated. To make it smaller, head over to the network tab in the browser developer tools to find which files are really necessary for it to function, and delete the ones that aren't. This helps make it more managable both for github and for the RoboRIO
