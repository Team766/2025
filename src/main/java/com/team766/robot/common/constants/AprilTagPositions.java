...
public final class AprilTagPositions {
    ...
    public static final Map<Integer, Pose2d> TAGS_2025 =
            Map.ofEntries(
                    ...
                    Map.entry(8, new Pose2d(new Translation2d(530.49, 186.83), new Rotation2d())),
                    ...
                    Map.entry(11, new Pose2d(new Translation2d(497.77, 130.17), new Rotation2d())),
                    ...
                    Map.entry(15, new Pose2d(new Translation2d(325.68, 75.39), new Rotation2d())),
                    Map.entry(16, new Pose2d(new Translation2d(235.73, -0.15), new Rotation2d())),
