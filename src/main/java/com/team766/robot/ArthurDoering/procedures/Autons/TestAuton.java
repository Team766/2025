...
import com.team766.robot.ArthurDoering.procedures.DriveBackwardsProcedure;
...
public class TestAuton extends Procedure {
    ...
    public void run(Context context) {
        ...
        context.runSync(new DriveBackwardsProcedure(drive, 0.3));
        context.runSync(new ShootProcedure(shoot, intake, 0.5));
    }
}
