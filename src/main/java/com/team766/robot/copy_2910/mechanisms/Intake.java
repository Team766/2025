...
public class Intake extends MechanismWithStatus<Intake.IntakeStatus> {
    ...
    public record IntakeStatus(
            ...
            double backCenterDistance) implements Status{
    ...
    protected IntakeStatus updateStatus() {
        try{
            ...
            log("Error reading CAN Range Time of Flight sensors: " + e.getMessage(), Severity.ERROR);
        }

        return new IntakeStatus(Double.MAX_VALUE, Double.MAX_VALUE, 
