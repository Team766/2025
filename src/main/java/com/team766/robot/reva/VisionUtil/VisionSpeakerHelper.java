...
public class VisionSpeakerHelper {
    ...
    private SwerveDrive.DriveStatus driveStatus;
    ...
    private boolean updateTarget() {
        try {
            ...
            Transform3d transform3d = cameraStatus.speakerTagTransform().orElseThrow();
        ...
        try {
            ...
            relativeTranslation2d =
                    absTargetPos
                            ...
                            .rotateBy(Rotation2d.fromDegrees(-driveStatus.headingDeg() - 180));
        }
    }

    public void update() {
        cameraStatus =
                StatusBus.getInstance()
                        .getStatusOrThrow(ForwardApriltagCamera.ApriltagCameraStatus.class);
        driveStatus = StatusBus.getInstance().getStatusOrThrow(SwerveDrive.DriveStatus.class);
    ...
    public Rotation2d getHeadingToTarget() {
        ...
        double val = relativeTranslation2d.getAngle().getDegrees() + driveStatus.headingDeg();
