...
public class ElevatorOI extends RuleGroup {
    public ElevatorOI(JoystickReader gamePad, Elevator elevator) {
        addRule(
                "Move Elevator L1",
                new LogicalAnd(
                        gamePad.whenButton(InputConstants.BUTTON_ELEVATOR_WRIST_L1),
        ...
        addRule(
                "Move Elevator L2",
                new LogicalAnd(
                        gamePad.whenButton(InputConstants.BUTTON_ELEVATOR_WRIST_L2),
                        gamePad.whenAxisMoved(InputConstants.GAMEPAD_RIGHT_TRIGGER)),
                ONCE,
                elevator,
                () -> {
        ...
        addRule(
                "Move Elevator L3",
                new LogicalAnd(
                        gamePad.whenButton(InputConstants.BUTTON_ELEVATOR_WRIST_L3),
                        gamePad.whenAxisMoved(InputConstants.GAMEPAD_RIGHT_TRIGGER)),
                ONCE,
                elevator,
                () -> {
        ...
        addRule(
                "Move Elevator L4",
                new LogicalAnd(
                        gamePad.whenButton(InputConstants.BUTTON_ELEVATOR_WRIST_L4),
                        gamePad.whenAxisMoved(InputConstants.GAMEPAD_RIGHT_TRIGGER)),
                ONCE,
                elevator,
                () -> {
